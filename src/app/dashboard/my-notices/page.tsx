              ...
              {data?.data?.map((n: Notice, index: number) => (
                <tr key={n._id}>
                  ...
                  <td className="flex flex-wrap gap-2">
                    <Link href={`/notices/${n._id}`} className="btn btn-secondary btn-sm">
                      View
                    </Link>

                    {!isDeleted && (
                      <>
                        <Link href={`/dashboard/notices/edit/${n._id}`} className="btn btn-info btn-sm">
                          Edit
                        </Link>
...
>>>>>>> 4fba2396524211f47ea000b97c8da93261a1ffa1
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                <Link href={`/notices/${n._id}`} className="btn btn-secondary btn-sm w-full">
                  View
                </Link>

                {!isDeleted && (
                  <>
                    <Link href={`/dashboard/notices/edit/${n._id}`} className="btn btn-info btn-sm w-full">
                      Edit
                    </Link>
